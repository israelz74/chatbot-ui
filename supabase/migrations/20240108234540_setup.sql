...
AS $$
DECLARE
  project_url TEXT := 'https://zxbzdnmhjxyumpjgdzby.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp4Ynpkbm1oanh5dW1wamdkemJ5Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc0NjQzMzgwNiwiZXhwIjoyMDYyMDA5ODA2fQ.QhiQ3prfrTMotr2ZVaX5KucYCX4Sa1FqqcZFc8_Ecdg'; -- full access needed for http request to storage
